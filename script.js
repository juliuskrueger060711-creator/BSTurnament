...
const rounds = [
  ...
  },
  {
    round: 2,
    matches: [
      ["Max + Jonas", "Filip + Timm"],
      ["Qusai + Louis", "Matti + Lukas"],
      ["Julius + Nick", "Ole + Til"],
    ],
  },
  {
    round: 3,
    matches: [
      ["Max + Jonas", "Matti + Lukas"],
      ["Filip + Timm", "Ole + Til"],
      ["Qusai + Louis", "Julius + Nick"],
    ],
  },
  {
    round: 4,
    matches: [
      ["Max + Jonas", "Ole + Til"],
      ["Matti + Lukas", "Julius + Nick"],
      ["Filip + Timm", "Qusai + Louis"],
    ],
  },
  {
    round: 5,
